-- 37b_fix_v_agro_input_cost_per_field_month.sql
-- Фикс: убрана лишняя невыверенная колонка n."Description" (category_placeholder)
-- и дублирующий join на raw.r1c_nomenclature. Категория считается один раз.
